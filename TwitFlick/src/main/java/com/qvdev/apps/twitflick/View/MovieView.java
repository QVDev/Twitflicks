...
import com.qvdev.apps.twitflick.Presenter.MoviePresenter;
...
public class MovieView extends YouTubePlayerSupportFragment implements Observer, View.OnClickListener {
    ...
    private void initLayout() {
        ...
        mVideoThumbnail.initialize(DeveloperKey.DEVELOPER_KEY_YOUTUBE, mMoviePresenter);
    ...
    private void trailerClicked() {
        mMoviePresenter.trailerClicked();
    }

    @Override
    public void update(Observable observable, Object buzzingDetails) {
        mMoviePresenter.update((BuzzingDetail) buzzingDetails);
    }
